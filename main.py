...
tamanhoPersonagem = 120, 160
tamanhoBatSinal = 64, 48
...
class HomemAranha(Sprite):  # criamos o primeiro sprint que irá compor o jogo, o objeto principal.
    def __init__(self, teia):
        ...
        self.image = scale(load('images/batman_small.png'),
                           tamanhoPersonagem)  # carrego a imagem e em seguida tranfiro para uma variável.
...
class Teia(Sprite):  # criamos o segundo sprite que irá compor o jogo.
    def __init__(self, x, y):
        super().__init__()

        self.image = scale(load('images/bat_sinal.png'), tamanhoBatSinal)
...
class Inimigo(Sprite):  # criamos o segundo sprint que irá compor o jogo.
    def __init__(self):
        ...
        self.image = scale(load('images/inimigo_1.png'), tamanhoPersonagem)
        self.rect = self.image.get_rect(
...
class Chefao(Sprite):  # criamos o segundo sprint que irá compor o jogo.
    def __init__(self):
        ...
        self.image = scale(load('images/inimigo_2.png'), tamanhoPersonagem)
        self.rect = self.image.get_rect(
...
while True:
    ...
    if disparo > 10:
        ...
        vencer = font.render("Gotham Salva!", True, (255, 255, 0))
        rect = pygame.Rect(50, 200, 0, 0)
        superficie.blit(vencer, rect)
    else:
        resposta = False
